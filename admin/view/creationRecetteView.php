			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<form id="testform" action="index.php?action=publishRecette" method="post">
								<div class="">
								...
								<div class="">
									...
									<textarea name="content" cols="30" rows="10" id="editor-show" style="display: none;"></textarea>
									<div class="ln_solid"></div> 
								</div>
								
								<!-- <button class="btn btn-success" type="submit">Publier</button> -->
								<button id="bouton1" class="btn btn-warning">qwdqwd</button>
							</form>
						</div>
					</div>
				</div>
