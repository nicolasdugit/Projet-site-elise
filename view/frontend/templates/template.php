...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="colorlib-page">
					...
					<div class="col-md-7">
						<div class="row">
							<div class="col-md-6 animate-box">
								<div class="about-img" style="background-image: url(public/images/about.jpg);">
								</div>
							</div>
							<div class="col-md-6 animate-box">
								<div class="about-img about-img-2" style="background-image: url(public/images/about-2.jpg);">
								</div>
							</div>
						</div>
					</div>
		...
		<div class="colorlib-introduction" style="background-image: url(public/images/cover_bg_1.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 col-pb-sm">
							<h2>Instagram</h2>
							<div class="instagram">
								<a href="#" class="insta-img" style="background-image: url(public/images/dessert-1.jpg);"></a>
								<a href="#" class="insta-img" style="background-image: url(public/images/dessert-2.jpg);"></a>
								<a href="#" class="insta-img" style="background-image: url(public/images/dish-9.jpg);"></a>
								<a href="#" class="insta-img" style="background-image: url(public/images/dish-2.jpg);"></a>
							</div>
						</div>
						<div class="col-md-3 col-pb-sm">
							<h2>Newsletter</h2>
