	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-md-offset-0 text-center animate-box intro-heading">
				<h2>Notre Equipe</h2>
				<p> la Poissonnerie, l’esprit d’équipe est très important. Ici, on travaille dans la joie et la bonne humeur. Toute l’équipe est à votre disposition pour vous servir et vous conseiller tout au long de l’année.</p>
			</div>
		</div>
	</div>
</div>
